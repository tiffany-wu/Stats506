...
isPalindromic <- function(number) {
  ...
  # Check if the reversed number ends in a zero: ChatGPT helped with the grepl string manipulation.
  if (grepl("0$", num_str)) {
    message("The reversed number ends in a zero. Outputting the reversed string.")
