...
## Github Link:
https://github.com/tiffany-wu/Stats506/tree/82d6a77efe3b9cb471a1524e56975965d28183a4/PS1 
...
# Remove specific multimillion and billionaire outliers
us_dollars_filtered <- us_dollars_salary2[
  !(us_dollars_salary2$Annual_Salary %in% c(10000000, 102000000)), 
]

# Get max and min
max(us_dollars_filtered$Annual_Salary)
min(us_dollars_filtered$Annual_Salary)
median(us_dollars_filtered$Annual_Salary)
```
...
cor(us_dollars_factor$Years_Experience_Total, us_dollars_factor$Years_Experience_Field,
    use = "complete.obs")
